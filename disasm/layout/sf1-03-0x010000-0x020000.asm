...
; GAME SECTION 03 :
; 0x010000..0x020000 : Exploration engine, ...
...
p_table_MapspriteSpeechSfx:
		dc.l table_MapspriteSpeechSfx
...
p_pt_BattleExits:
		dc.l pt_BattleExits
p_BattleChests: dc.l table_BattleChests
...
loc_119EC:
		...
		bra.s   loc_119EC
loc_119FC:
		move.l  #-1,(MAP_SPRITE_DATA_POINTER).l
		move.b  #-1,(DIALOG_INDEX).l
		rts
loc_11A10:
		move.b  1(a0,d1.w),d0
		bsr.s   sub_11A30
...
loc_120AC:
		...
		btst    #1,(byte_FF9C59).l
		beq.s   return_120EE
		move.b  #-1,(byte_FF5011).l
		move.b  #-1,(word_FF5030+1).l
		move.b  #-1,(byte_FF5051).l
...
loc_12138:
		...
		bra.s   return_121EA
loc_1218A:
		move.b  #-1,(byte_FF5141).l
		bra.s   return_121EA
loc_12194:
		move.b  #-1,(byte_FF5141).l
		move.b  #-1,(byte_FF5121).l
		move.b  #-1,(byte_FF5131).l
		move.b  #-1,(byte_FF50E1).l
...
loc_12232:
		...
		beq.s   loc_1224E
		move.b  #-1,(byte_FF5181).l
loc_1224E:
		btst    #1,(byte_FF9C5C).l
		beq.s   loc_1228A
		move.b  #-1,(byte_FF51C1).l
		move.b  #-1,(byte_FF5051).l
...
loc_12454:
		...
		btst    #4,(byte_FF9C59).l
		beq.s   loc_12470
		move.b  #-1,(byte_FF5191).l
loc_12470:
		btst    #6,(byte_FF9C59).l
		beq.s   return_12482
		move.b  #-1,(byte_FF50B1).l
return_12482:
		rts
loc_12484:
...
loc_129B0:
		btst    #6,(byte_FF9C59).l
		beq.s   loc_129C2
		move.b  #-1,(word_FF5100+1).l
loc_129C2:
		btst    #7,(byte_FF9C59).l
		beq.s   loc_129D4
		move.b  #-1,(byte_FF50D1).l
loc_129D4:
		btst    #2,(byte_FF9C59).l
		bne.s   loc_129FA
...
loc_12D48:
		...
		move.b  3(a0,d7.w),d0
		add.b   d0,d0
		move.b  (table_12D72-2)(pc,d0.w),d1
		move.b  (table_12D72-1)(pc,d0.w),d0
...
sub_13828:
		...
		bne.w   byte_139B0      
		movem.w d0,-(sp)
		txt     77              ; "[Hero] opens[Line]the treasure chest![Wait2]"
...
loc_15F82:
		...
		move.b  $A(a0),$B(a0)
loc_15F9E:
		jsr     j_GetMapspriteScriptAddress
		bcs.s   loc_15FAE
loc_15FA6:
		bsr.s   sub_15FC2
		lsl.w   #2,d0
...
@Return:
    ...
    ; End of function DisplayPortraitInMenu
		...
		include "code\common\shopactions.asm"		; Shop menu functions
...
loc_16F56:
    ...
    ; End of function LoadShopInventory
		...
		include "data\stats\items\shopdata.asm"		; Shop data
		include "code\common\churchactions.asm"		; Church menu functions
...
loc_17BB6:
    ...
    ; End of function sub_17B10
		...
		include "data\stats\spritespeechsfx.asm"		; Sprite dialog bleeps
...
loc_17F60:
    ...
    ; End of function RemoveItemFromForce


; =============== S U B R O U T I N E =======================================

; Cutscene Function : SetSpeechSfx
...
CutsceneFunction_SetSpeechSfx:
		...
		clr.w   d1
		move.b  d0,d1
		lea     table_MapspriteSpeechSfx(pc), a0
		move.b  (a0,d1.w),d1
		beq.s   @NoSpeechSfx
...
loc_1AB58:
		...
		bsr.w   CutsceneFunction_SetSpeechSfx
		move.l  (sp)+,d0
		moveq   #MAPSPRITE_KOKICHI_WKNT,d0
		jsr     (a4)
		moveq   #3,d0
		jsr     (a5)
		rts
...
loc_1DC9C:
		...
		movea.l (p_tiles_EndingMax1).l,a0
		lea     ($8000).l,a1
		move.w  #$900,d0
		move.w  #2,d1
		jsr     (j_ApplyImmediateVramDmaOnCompressedTiles).l
		movea.l (p_tiles_EndingAdam).l,a0
		lea     ($9200).l,a1
		move.w  #$400,d0
		move.w  #2,d1
		jsr     (j_ApplyImmediateVramDmaOnCompressedTiles).l
		movea.l (p_tiles_EndingFarmer).l,a0
		lea     ($9A00).l,a1
		move.w  #$600,d0
		move.w  #2,d1
		jsr     (j_ApplyImmediateVramDmaOnCompressedTiles).l
		movea.l (p_tiles_EndingTheEnd).l,a0
		lea     ($6000).w,a1
		move.w  #$600,d0
		move.w  #2,d1
		jsr     (j_ApplyImmediateVramDmaOnCompressedTiles).l
		...
		jsr     (j_FadeInFromBlack).l
		txt     94              ; "Well, hello there.[Delay2][Delay2][Line]You look like you're[Line]a long way from home.[Delay2][Delay2]"
		clearTxt
		txt     95              ; "We don't see many folk in[Line]full armor like that.[Delay2][Delay2][Delay2][Line]Quite a fancy getup![Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     96              ; "I have come a long way.[Delay2][Delay2][Delay2][Line]Longer than you can[Line]imagine.[Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     97              ; "I must say you do look pretty[Line]tired and, well,[Delay2][Delay2][Line]your things have seen[Line]better days.[Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     98              ; "I'm tired of wandering.[Delay2][Delay2][Line]I'm looking for a place to[Line]settle down and rest.[Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     99              ; "Well, how about right here?[Delay2][Delay2][Line]Lend your hands to the fields[Line]of our village?[Delay2][Delay2][Delay2][Delay2]"
		moveq   #$33,d7 
loc_1DD9C:
		move.w  d7,-(sp)
...
loc_1DDBA:
		...
		clearTxt
		txt     100             ; "That sounds like just what I[Line]need right now. [Delay2][Delay2][Delay2]I work hard[Line]and I'm a fast learner.[Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     101             ; "Good! We've got a deal then.[Delay2][Delay2][Delay2][Line]Folks in the village will be[Line]excited to see a new face![Delay2][Delay2]"
		clearTxt
		txt     102             ; "I didn't catch your name.[Line]What do they call you?[Delay2][Delay2][Delay2][Delay2]"
		clearTxt
		txt     103             ; "Me? You can call me...[Delay2][Delay2]"
		clearTxt
		movea.l (p_tiles_EndingMax2).l,a0
		lea     ($8000).l,a1
		move.w  #$900,d0
		move.w  #2,d1
		...
		moveq   #3,d0
		jsr     (j_Sleep).l
		movea.l (p_tiles_EndingMax3).l,a0
		lea     ($8000).l,a1
		move.w  #$900,d0
		move.w  #2,d1
		jsr     (j_ApplyVIntVramDmaOnCompressedTiles).l
		...
		moveq   #18,d0
		jsr     (j_Sleep).l
		movea.l (p_tiles_EndingMax4).l,a0
		lea     ($8000).l,a1
		move.w  #$900,d0
		move.w  #2,d1
		jsr     (j_ApplyVIntVramDmaOnCompressedTiles).l
...
pt_IntroTiles:  dc.l tiles_Intro00
		dc.l tiles_Intro01
		dc.l tiles_Intro02
		dc.l tiles_Intro03
		dc.l tiles_Intro04
		...
		dc.l tiles_Intro14
		dc.l tiles_Intro15
tiles_Intro00:  incbin "data/graphics/introtiles/introtile00.bin"
tiles_Intro01:  incbin "data/graphics/introtiles/introtile01.bin"
tiles_Intro02:  incbin "data/graphics/introtiles/introtile02.bin"
tiles_Intro03:  incbin "data/graphics/introtiles/introtile03.bin"
tiles_Intro04:  incbin "data/graphics/introtiles/introtile04.bin"
tiles_Intro05:  incbin "data/graphics/introtiles/introtile05.bin"
tiles_Intro06:  incbin "data/graphics/introtiles/introtile06.bin"
tiles_Intro07:  incbin "data/graphics/introtiles/introtile07.bin"
tiles_Intro08:  incbin "data/graphics/introtiles/introtile08.bin"
tiles_Intro09:  incbin "data/graphics/introtiles/introtile09.bin"
tiles_Intro10:  incbin "data/graphics/introtiles/introtile10.bin"
tiles_Intro11:  incbin "data/graphics/introtiles/introtile11.bin"
tiles_Intro12:  incbin "data/graphics/introtiles/introtile12.bin"
tiles_Intro13:  incbin "data/graphics/introtiles/introtile13.bin"
tiles_Intro14:  incbin "data/graphics/introtiles/introtile14.bin"
tiles_Intro15:  incbin "data/graphics/introtiles/introtile15.bin"
byte_1E37A:     dc.b 1
		dc.b 0
		dc.b 1
		dc.b 4
		...
		dc.b 2
		dc.b $7F
sprite_1E67A:   ; sprite properties data
		vdpSprite 168, V4|H4|33, 1024|PALETTE2, 384
		vdpSprite 200, V4|H4|34, 1040|PALETTE2, 384
		vdpSprite 232, V4|H4|35, 1056|PALETTE2, 384
		vdpSprite 168, V4|H4|36, 1072|PALETTE2, 416
		vdpSprite 200, V4|H4|37, 1088|PALETTE2, 416
		vdpSprite 232, V4|H4|38, 1104|PALETTE2, 416
		vdpSprite 168, V4|H4|39, 1120|PALETTE2, 448
		vdpSprite 200, V4|H4|40, 1136|PALETTE2, 448
		vdpSprite 232, V4|H4|41, 1152|PALETTE2, 448
		vdpSprite 200, V4|H4|42, 1168|PALETTE4, 320
		vdpSprite 232, V4|H4|43, 1184|PALETTE4, 320
		vdpSprite 200, V4|H4|44, 1200|PALETTE4, 352
		vdpSprite 232, V4|H4|45, 1216|PALETTE4, 352
		vdpSprite 200, V4|H4|46, 1232|PALETTE4, 152
		vdpSprite 232, V4|H4|47, 1248|PALETTE4, 152
		vdpSprite 200, V4|H4|48, 1264|PALETTE4, 184
		vdpSprite 232, V4|H4|49, 1280|PALETTE4, 184
		vdpSprite 200, V4|H4|50, 1296|PALETTE4, 216
		vdpSprite 232, V4|H4|51, 1312|PALETTE4, 216
                
layout_1E712:   ; 1st line
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 768|PALETTE3|PRIORITY_BIT
		vdpTile 769|PALETTE3|PRIORITY_BIT
		vdpTile 770|PALETTE3|PRIORITY_BIT
		vdpTile 771|PALETTE3|PRIORITY_BIT
		vdpTile 772|PALETTE3|PRIORITY_BIT
		vdpTile 773|PALETTE3|PRIORITY_BIT
		vdpTile 774|PALETTE3|PRIORITY_BIT
		vdpTile 775|PALETTE3|PRIORITY_BIT
		vdpTile 776|PALETTE3|PRIORITY_BIT
		vdpTile 777|PALETTE3|PRIORITY_BIT
		vdpTile 778|PALETTE3|PRIORITY_BIT
		vdpTile 779|PALETTE3|PRIORITY_BIT
		vdpTile 780|PALETTE3|PRIORITY_BIT
		vdpTile 781|PALETTE3|PRIORITY_BIT
		vdpTile 782|PALETTE3|PRIORITY_BIT
		vdpTile 783|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 784|PALETTE3|PRIORITY_BIT
		vdpTile 785|PALETTE3|PRIORITY_BIT
		vdpTile 786|PALETTE3|PRIORITY_BIT
		vdpTile 787|PALETTE3|PRIORITY_BIT
		vdpTile 788|PALETTE3|PRIORITY_BIT
		vdpTile 789|PALETTE3|PRIORITY_BIT
		vdpTile 790|PALETTE3|PRIORITY_BIT
		vdpTile 791|PALETTE3|PRIORITY_BIT
		vdpTile 792|PALETTE3|PRIORITY_BIT
		vdpTile 793|PALETTE3|PRIORITY_BIT
		vdpTile 794|PALETTE3|PRIORITY_BIT
		vdpTile 795|PALETTE3|PRIORITY_BIT
		vdpTile 796|PALETTE3|PRIORITY_BIT
		vdpTile 797|PALETTE3|PRIORITY_BIT
		vdpTile 798|PALETTE3|PRIORITY_BIT
		vdpTile 799|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 800|PALETTE3|PRIORITY_BIT
		vdpTile 801|PALETTE3|PRIORITY_BIT
		vdpTile 802|PALETTE3|PRIORITY_BIT
		vdpTile 803|PALETTE3|PRIORITY_BIT
		vdpTile 804|PALETTE3|PRIORITY_BIT
		vdpTile 805|PALETTE3|PRIORITY_BIT
		vdpTile 806|PALETTE3|PRIORITY_BIT
		vdpTile 807|PALETTE3|PRIORITY_BIT
		vdpTile 808|PALETTE3|PRIORITY_BIT
		vdpTile 809|PALETTE3|PRIORITY_BIT
		vdpTile 810|PALETTE3|PRIORITY_BIT
		vdpTile 811|PALETTE3|PRIORITY_BIT
		vdpTile 812|PALETTE3|PRIORITY_BIT
		vdpTile 813|PALETTE3|PRIORITY_BIT
		vdpTile 814|PALETTE3|PRIORITY_BIT
		vdpTile 815|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 816|PALETTE3|PRIORITY_BIT
		vdpTile 817|PALETTE3|PRIORITY_BIT
		vdpTile 818|PALETTE3|PRIORITY_BIT
		vdpTile 819|PALETTE3|PRIORITY_BIT
		vdpTile 820|PALETTE3|PRIORITY_BIT
		vdpTile 821|PALETTE3|PRIORITY_BIT
		vdpTile 822|PALETTE3|PRIORITY_BIT
		vdpTile 823|PALETTE3|PRIORITY_BIT
		vdpTile 824|PALETTE3|PRIORITY_BIT
		vdpTile 825|PALETTE3|PRIORITY_BIT
		vdpTile 826|PALETTE3|PRIORITY_BIT
		vdpTile 827|PALETTE3|PRIORITY_BIT
		vdpTile 828|PALETTE3|PRIORITY_BIT
		vdpTile 829|PALETTE3|PRIORITY_BIT
		vdpTile 830|PALETTE3|PRIORITY_BIT
		vdpTile 831|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 832|PALETTE3|PRIORITY_BIT
		vdpTile 833|PALETTE3|PRIORITY_BIT
		vdpTile 834|PALETTE3|PRIORITY_BIT
		vdpTile 835|PALETTE3|PRIORITY_BIT
		vdpTile 836|PALETTE3|PRIORITY_BIT
		vdpTile 837|PALETTE3|PRIORITY_BIT
		vdpTile 838|PALETTE3|PRIORITY_BIT
		vdpTile 839|PALETTE3|PRIORITY_BIT
		vdpTile 840|PALETTE3|PRIORITY_BIT
		vdpTile 841|PALETTE3|PRIORITY_BIT
		vdpTile 842|PALETTE3|PRIORITY_BIT
		vdpTile 843|PALETTE3|PRIORITY_BIT
		vdpTile 844|PALETTE3|PRIORITY_BIT
		vdpTile 845|PALETTE3|PRIORITY_BIT
		vdpTile 846|PALETTE3|PRIORITY_BIT
		vdpTile 847|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
		...
		vdpTile 
		vdpTile 
		vdpTile 848|PALETTE3|PRIORITY_BIT
		vdpTile 849|PALETTE3|PRIORITY_BIT
		vdpTile 850|PALETTE3|PRIORITY_BIT
		vdpTile 851|PALETTE3|PRIORITY_BIT
		vdpTile 852|PALETTE3|PRIORITY_BIT
		vdpTile 853|PALETTE3|PRIORITY_BIT
		vdpTile 854|PALETTE3|PRIORITY_BIT
		vdpTile 855|PALETTE3|PRIORITY_BIT
		vdpTile 856|PALETTE3|PRIORITY_BIT
		vdpTile 857|PALETTE3|PRIORITY_BIT
		vdpTile 858|PALETTE3|PRIORITY_BIT
		vdpTile 859|PALETTE3|PRIORITY_BIT
		vdpTile 860|PALETTE3|PRIORITY_BIT
		vdpTile 861|PALETTE3|PRIORITY_BIT
		vdpTile 862|PALETTE3|PRIORITY_BIT
		vdpTile 863|PALETTE3|PRIORITY_BIT
		vdpTile 
		vdpTile 
		vdpTile 
		vdpTile 
...
TextBankTreeData:
		...
		include "code\common\scripting\text\huffmandecoder.asm"		; Text decoding functions
		align $8000
