...
p_rpt_GrowthCurves: dc.l rpt_GrowthCurves
p_UnpromotedGrowths:
...
AiAction_UseItem:
		...
		add.b   d2,d2               ; new code
		jsr     j_GetEntityItemsAddressForCombatant
		move.w  (a0,d2.w),d1    ; D1 = item index in slot number D2 ; 0x240F6
		cmpi.w  #$00FF,d1 ; empty slot ; 0x240FA
