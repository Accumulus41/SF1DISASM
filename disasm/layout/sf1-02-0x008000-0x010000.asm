...
loc_8110:
		move.b  #-1,((byte_FFB4D3-$1000000)).w
		bra.w   loc_81D4
...
loc_81D4:
		...
		clr.w   d0
		move.b  (a0),d0
		move.b  d0,((CURRENTLY_MOVING_COMBATANT-$1000000)).w
		cmpi.b  #-1,d0
		beq.w   loc_8284
		...
		bsr.w   sub_AB5C
		move.b  ((CURRENTLY_MOVING_COMBATANT-$1000000)).w,d0
		tst.b   ((byte_FFB4D7-$1000000)).w
		bne.s   loc_824A
		jsr     j_IsAsleep
...
loc_8296:
		...
		txt     433             ; "[Hero] has been[Line]defeated...[Wait2]"
...
loc_82DC:
		...
		bsr.w   sub_AB2C
		jsr     j_ExecuteAfterBattleScript
		jsr     sub_20040
		bsr.w   LoadCursorTiles
...
loc_84DE:
		...
		move.b  #-1,((ACTOR_BLINKING_TOGGLE-$1000000)).w
loc_8532:
...
LoadCursorSpriteData:
		...
		tst.b   ((byte_FFB538-$1000000)).w
		bne.w   loc_891C
		lea     sprite_TargetingCursors(pc), a0
		clr.w   d0
...
loc_87F4:
		...
		beq.s   loc_883E
		lea     sprite_DefaultTargetingCursor(pc), a0
		move.w  ((SCREEN_ADJUSTED_CURSOR_Y-$1000000)).w,d0
		add.w   (a0)+,d0
		ext.w   d2
		add.w   d2,d0
...
loc_9856:
		bsr.s   sub_9872
		moveq   #COMBATANT_ENTRIES_COUNTER-1,d7
loc_985A:
		moveq   #COMBATANT_ENTRIES_COUNTER,d0
		sub.w   d7,d0
		moveq   #$70,d1 
...
sub_9B4E:
		cmpi.b  #-1,((byte_FFB5B1-$1000000)).w
		beq.s   return_9BA8
...
loc_9ECC:
		...
		bne.s   byte_9EF8       
		txt     435             ; "[Hero]! You've reached[Line]your destination, but some[Line]enemies remain.[Wait2][Line]Will you leave them?"
		bra.s   loc_9EFE
byte_9EF8:
		txt     434             ; "[Hero]! Do you really[Line]want to retreat from this[Line]battle?"
loc_9EFE:
...
battleMenuAction_Magic:
		...
		move.b  #BATTLEACTION_TYPE_CAST_SPELL,((BATTLE_ACTION_TYPE-$1000000)).w
...
return_A32A:
		rts
loc_A32C:
		move.b  #BATTLEACTION_TYPE_USE_ITEM,((BATTLE_ACTION_TYPE-$1000000)).w
		move.b  ((ACTOR_BLINKING_TOGGLE-$1000000)).w,((byte_FFB4C9-$1000000)).w
		clr.w   d0
		move.b  ((byte_FFB4C5-$1000000)).w,d0
...
sub_A656:
		move.b  #-1,((byte_FFB537-$1000000)).w
		clr.b   ((byte_FFB4CB-$1000000)).w
		move.b  ((byte_FFB4C5-$1000000)).w,d0
loc_A664:
		tst.b   ((byte_FFB4D7-$1000000)).w
...
loc_A744:
		...
		clr.b   ((byte_FFB4CA-$1000000)).w
		clr.b   ((byte_FFB4CB-$1000000)).w
		cmpi.b  #BATTLEACTION_TYPE_3,((BATTLE_ACTION_TYPE-$1000000)).w
		beq.w   sub_A656
		move.b  #-1,((byte_FFB4D3-$1000000)).w
		bsr.w   UpdateBattlefieldSprites
		bsr.w   sub_AC86
...
loc_B168:
		...
		bne.s   loc_B1BA
		movem.l d7-a1,-(sp)
		lea     layout_StatusGoldWindow(pc), a0
...
loc_B1E8:
		...
		move.l  #sub_B4F8,(VINT_CONTEXTUAL_FUNCTION_ADDRESS).l
		movem.l d7-a1,-(sp)
		lea     layout_StatusMainWindow(pc), a0
loc_B210:
		lea     ((WINDOW_LAYOUT_LOADING_SPACE-$1000000)).w,a1
loc_B214:
		move.w  #$478,d7
...
loc_B4C6:
		...
		cmpi.w  #$FFD0,d4
		blt.s   loc_B4E8
		moveq   #COMBATANT_ENTRIES_COUNTER,d3
		sub.w   d0,d3
		move.b  d3,(a1)+
		bra.s   loc_B4EC
loc_B4E8:
...
sub_B936:
    ...
    ; End of function sub_B936
		...
		include "data\graphics\tech\windowlayouts\statusscreen.asm"		; Status screen window layouts
...
pt_MenuTiles:   dc.l p_tiles_OptionsMenu
		dc.l p_tiles_MainMenu
		dc.l p_tiles_OptionsMenu
		dc.l p_tiles_OptionsMenu
...
sprite_C792:    ; icon highlight sprite properties
		vdpSprite 295, V4|H3|1, 2012|PALETTE3|PRIORITY_BIT, 255
		vdpSprite 307, V4|H3|1, 2012|PALETTE3|PRIORITY_BIT, 239
		vdpSprite 307, V4|H3|1, 2012|PALETTE3|PRIORITY_BIT, 271
		vdpSprite 319, V4|H3|1, 2012|PALETTE3|PRIORITY_BIT, 255
                
sprite_C7B2:    vdpSprite 320, V1|H4|2, 2024|PALETTE3|PRIORITY_BIT, 296
...
aPromote:       dc.b 7,'PROMOTE'
		...
		include "data\graphics\tech\windowlayouts\C900.asm"		; Unknown layout
		include "data\graphics\tech\windowlayouts\CC90.asm"		; Unknown layout
tiles_IconHighlight:
...
loc_D02E:
		...
		subi.w  #9,d7
loc_D056:
		lea     layout_D24E(pc), a0
		nop
		bsr.w   sub_D1B2
		dbf     d7,loc_D056
                
		lea     layout_D258(pc), a0
		nop
		bsr.w   sub_D1B2
		bsr.w   sub_D1B2
		bsr.w   sub_D1B2
...
@Return:
    ...
    ; End of function CapMiniStatusBarLength
		...
		include "data\graphics\tech\windowlayouts\ministatus.asm"		; Mini status window layouts
...
sub_D32C:
    ...
    ; End of function sub_D32C
		...
		include "data\graphics\tech\windowlayouts\miscmessages\entries.asm"		; Misc message window layout
...
sub_DAE2:
		bsr.w   sub_DB76
		lea     layout_BattleEquipItemNameWindow(pc), a0
		lea     ((WINDOW_LAYOUT_LOADING_SPACE-$1000000)).w,a1
		move.w  #$CC,d7 
		jsr     (j_CopyBytes).l
		bra.w   loc_DCA4
...
BuildBattleEquipStatsWindow:
		...
		lea     layout_BattleEquipStatsWindow(pc), a0
		lea     ((WINDOW_LAYOUT_LOADING_SPACE-$1000000)).w,a1
		move.w  #$D8,d7 
		jsr     (j_CopyBytes).l
		clr.w   d0
...
aRemove_0:      dc.b VDPTILE_ORANGE_UPPERCASE_R
...
aWeaponring_0:  dc.b 'WEAPONRING',0,0
		...
		include "data\graphics\tech\windowlayouts\battleequipmenu.asm"		; Battle equip menu window layouts
		include "code\common\menus\landeffectwindow.asm"		; Land effect window functions
		include "data\graphics\tech\windowlayouts\landeffect.asm"		; Land effect window layout
...
table_E0F6:     dc.w $85C0
		...
		include "data\graphics\tech\windowlayouts\portrait.asm"		; Portrait window layouts
		include "code\common\menus\shopscreen.asm"		; Shop screen functions
		include "code\common\menus\memberslistscreen.asm"		; Members list screen functions
		include "data\graphics\tech\windowlayouts\shopinventory.asm"		; Shop inventory window layouts
tiles_ShopIconHighlight:
		incbin "data/graphics/tech/menus/shopiconhighlighttiles.bin"
		include "data\graphics\tech\windowlayouts\shopitemnameandprice.asm"		; Shop item name and price window layout
		include "data\graphics\tech\windowlayouts\memberslistscreen.asm"		; Members list screen window layouts
		include "data\graphics\tech\windowlayouts\itemmenuitemname.asm"		; Item menu : Item name window layout
byte_F4DE:      dc.b 0
		dc.b 0
		dc.b 0
		dc.b 0
...
loc_FC20:
		...
		btst    #7,d0
		beq.s   loc_FC42
		move.w  #VDPTILE_92|VDPTILE_PALETTE3|VDPTILE_PRIORITY_BIT,4(a1)
		bra.s   loc_FC48
loc_FC42:
		move.w  #VDPTILE_94|VDPTILE_PALETTE3|VDPTILE_PRIORITY_BIT,4(a1)
loc_FC48:
		addq.l  #8,a0
		addq.l  #8,a1
		dbf     d7,loc_FC20
		...
		bra.s   return_FC92
loc_FC8C:
		move.w  #VDPTILE_59|VDPTILE_PALETTE3|VDPTILE_PRIORITY_BIT,4(a1)
return_FC92:
		rts
